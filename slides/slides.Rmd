...
# `PopED`: Add another post dose sample at SS
...
# `PopED`: *D*-optimal design: Add another post dose sample at SS
...
# `PopED`: Add sample after the final (SS) dose
...
# `PopED`: *D*-optimal design: Add sample after the final (SS) dose
...
# `PFIM`: *D*-optimal design: Add another post dose sample at SS
...
# `PFIM`: Add sample after the final (SS) dose
...
# `PFIM`: *D*-optimal design: Add sample after the final (SS) dose
...
.pull-left[
```{r pfim-test-plot-2, fig.show="hide", fig.width=4, fig.height=4}
plot_model_prediction(
  poped_db_practical,
  model.names = c("Day 1", "Steady state"),
  facet_scales = "free_x",
